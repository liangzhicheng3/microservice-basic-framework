...
public class SysMenuServiceImpl extends ServiceImpl<ISysMenuDao, SysMenuEntity> implements ISysMenuService {
    ...
    public List<SysMenuEntity> listOne() {
        return baseMapper.selectList(new LambdaQueryWrapper<SysMenuEntity>()
                .eq(SysMenuEntity::getLevel, Constants.ONE)
                .eq(SysMenuEntity::getDelFlag, Constants.ZERO)
    ...
    public List<SysMenuEntity> listTwoByOne(String oneId) {
        return baseMapper.selectList(new LambdaQueryWrapper<SysMenuEntity>()
                .eq(SysMenuEntity::getParentId, oneId).eq(SysMenuEntity::getLevel, Constants.TWO)
                .eq(SysMenuEntity::getDelFlag, Constants.ZERO).orderByAsc(SysMenuEntity::getRank));
    }
    ...
    public List<SysMenuEntity> listThreeByTwo(String twoId) {
        return baseMapper.selectList(new LambdaQueryWrapper<SysMenuEntity>()
                .eq(SysMenuEntity::getParentId, twoId).eq(SysMenuEntity::getLevel, Constants.THREE)
                .eq(SysMenuEntity::getDelFlag, Constants.ZERO).orderByAsc(SysMenuEntity::getRank));
    }
    ...
    public List<SysMenuEntity> listFourByThree(String threeId) {
        return baseMapper.selectList(new LambdaQueryWrapper<SysMenuEntity>()
                .eq(SysMenuEntity::getParentId, threeId).eq(SysMenuEntity::getLevel, "4")
                .eq(SysMenuEntity::getDelFlag, Constants.ZERO).orderByAsc(SysMenuEntity::getRank));
    }
    ...
    public SysMenuEntity updateDelFlag(String level, String pid){
        SysMenuEntity menu = baseMapper.selectOne(new LambdaQueryWrapper<SysMenuEntity>()
                .eq(SysMenuEntity::getLevel, level).eq(SysMenuEntity::getParentId, pid)
                .eq(SysMenuEntity::getDelFlag, Constants.ZERO));
