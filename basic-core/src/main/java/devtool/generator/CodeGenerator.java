...
public class CodeGenerator {
    ...
    public void generate(){
        String url = "jdbc:mysql://127.0.0.1:3306/test-user?useUnicode=true&characterEncoding=utf-8&zeroDateTimeBehavior=convertToNull&serverTimezone=Hongkong";
        ...
        String moduleName = "user"; //在哪个包下生成，代码最后会生成在parent.moduleName下，如：com.liangzhicheng.project
        String tablePrefix = ""; //表前缀，生成的java类名会去掉前缀
        String[] tables = new String[] { "test_user" }; //生成哪个表
